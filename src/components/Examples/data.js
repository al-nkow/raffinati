...
const Data = [
  {
    ...
    body: 'Комбинированные портьеры на профильном карнизе, расположенном в нише. Идеальное сочетание двух фактур атласных портьер с классическим рисунком. Композиция дополнена плотным тюлем креповой фактуры',
    days: 12,
  }, {
    id: 2,
    thumb: riverSmall,
    ...
    body: 'Портьеры на электрокарнизе из плотного натурального бархата цвета топленого молока были идеально подобраны к обивке кожаного дивана дополнены глянцевым тюлем жемчужного цвета. Бархатная фактура при дополнительном освещении меняет оттенок и играет разными красками в соответствии с решениями интерьера.',
    days: 25,
  }, {
    id: 4,
    thumb: image1Small,
